  ...
  return (
    <section className="py-8 md:py-10 lg:py-12 pb-16 md:pb-20 relative overflow-visible">
      ...
      <svg className="absolute inset-0 w-full h-full opacity-10" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <motion.path
          d="M0,300 Q250,250 500,300 T1000,300 L1000,400 L0,400 Z"
          fill="url(#waveGradient)"
          animate={{
            d: [
              "M0,300 Q250,250 500,300 T1000,300 L1000,400 L0,400 Z",
              "M0,300 Q250,350 500,300 T1000,300 L1000,400 L0,400 Z",
              "M0,300 Q250,250 500,300 T1000,300 L1000,400 L0,400 Z",
            ],
          }}
        ...
        {[...Array(30)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              top: `${Math.random() * 100}%`,
              background: i % 3 === 0 ? '#ff6b35' : i % 3 === 1 ? '#ef4444' : '#fbbf24',
            }}
            animate={{
              scale: [0, 1.5, 0],
              opacity: [0, 1, 0],
      ...
      {/* Floating circles with icons effect */}
      {[...Array(12)].map((_, i) => (
        <motion.div
          key={i}
